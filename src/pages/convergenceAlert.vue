...
const nginxLogColumns = computed(() => [
  ...
  { name: 'convergence_number', label: '收敛条数', align: 'center' }
])
// 分页表变量
                  ...
                  >
                    <template v-slot:body="props">
                      <q-tr :props="props">
                        ...
                        <q-td class="no-padding" key="convergence_number" :props="props">{{ props.row.convergence_number}}</q-td>
                      </q-tr>
                    </template>
